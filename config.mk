...
JEMALLOC_INC = /usr/include/
JEMALLOC_LIB = /usr/lib64/libjemalloc.so
...
#-L$(JEMALLOC_LIB) -ljemalloc

CFLAGS   = -std=c99   -march=native -O3  -pedantic -Wall    -finline-functions -finline-small-functions
#-I$(JEMALLOC_INC)
